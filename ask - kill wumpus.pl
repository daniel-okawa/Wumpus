...
act(strategy_find_out,turnleft) :-		% I shoot Wumpus only if I think
	agent_arrows(1),		% that we are in the same X
	agent_location([X,Y]),		% it means I assume Wumpus and me
	%location_ahead([X,NY]),
	%is_wumpus(yes,[X,WY]),		% are in the same column
...
act(strategy_find_out,turnright) :-		% I shoot Wumpus only if I think
	agent_arrows(1),		% that we are in the same X
	agent_location([X,Y]),		% it means I assume Wumpus and me
	%location_ahead([X,NY]),
	%is_wumpus(yes,[X,WY]),		% are in the same column
...
act(strategy_find_out,shoot) :-		% I shoot Wumpus only if I think
	agent_arrows(1),		% that we are in the same y
	agent_location([X,Y]),
	location_ahead([NX,Y]),
	is_wumpus(yes,[WX,Y]),
